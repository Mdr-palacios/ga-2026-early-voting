...
window.I18N = {
  en: {
    ...
    meta_early_voting_value: 'April 27 to May 15',
    meta_polls_open: 'Polls open Election Day:',
    meta_polls_open_value: '7am to 7pm',
    ...
    election_day_suffix: '· Polls 7a to 7p · Vote at your assigned precinct only',
    ...
    ballot_label_duties: 'Duties:',
    ballot_label_importance: 'Importance of role:',
    ballot_offices: [
      {
        name: 'Governor',
      ...
      },
      {
        ...
        what: 'Insurance Commissioner (regulates insurance and fire safety), Agriculture Commissioner (food safety and farms), Labor Commissioner (unemployment claims and workforce), and State School Superintendent (K to 12 public schools).',
  ...
  es: {
    ...
    meta_early_voting_value: 'del 27 de abril al 15 de mayo',
    meta_polls_open: 'Centros abiertos el día de elección:',
    meta_polls_open_value: 'de 7 a.m. a 7 p.m.',
    ...
    election_day_suffix: '· Centros abiertos de 7 a.m. a 7 p.m. · Vote solo en su centro asignado',
    ...
    /* Qué hay en su boleta: explicador de cargos */
    ...
    ballot_label_duties: 'Funciones:',
    ballot_label_importance: 'Importancia del cargo:',
    ballot_offices: [
      {
        name: 'Gobernador',
      ...
      },
      {
        ...
        what: 'Comisionado de Seguros (regula seguros y seguridad contra incendios), Comisionado de Agricultura (seguridad alimentaria y granjas), Comisionado de Trabajo (reclamos de desempleo y fuerza laboral) y Superintendente Escolar Estatal (escuelas públicas de K a 12).',
      ...
      },
      {
        ...
        what: 'El miembro del Congreso de su distrito (un mandato de dos años en Washington) vota leyes federales, el presupuesto federal y supervisa al ejecutivo.',
